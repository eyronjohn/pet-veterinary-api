  ...
  <header class="absolute inset-x-0 top-0 z-50">
    <nav aria-label="Global" class="flex items-center justify-between p-6 lg:px-8">
      ...
      <div class="hidden lg:flex lg:gap-x-12">
        <x-nav class="text-sm/6 font-semibold text-gray-900" href="/home">Home</x-nav>
        <x-nav class="text-sm/6 font-semibold text-gray-900" href="/about">About</x-nav>
        <x-nav class="text-sm/6 font-semibold text-gray-900" href="/contact">Contact</x-nav>
      </div>
